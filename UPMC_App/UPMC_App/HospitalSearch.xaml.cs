...
namespace UPMC_App
{
	...
	{
        DoctorSearchViewModel ViewModel = new DoctorSearchViewModel() { SearchPageTitle = "Hospital & Facility Search" };
        public HospitalSearch()
		{
			InitializeComponent ();
            BindingContext = ViewModel;
            ViewModel.LoadCategories(DoctorSearchViewModel.FACILITY_CAT_URL);
		}
        ...
        private void ByService_Tapped(object sender, EventArgs e)
        {
