...
namespace UPMC_App
{
	...
	public partial class PharmacySearchPage : ContentPage
	{
        DoctorSearchViewModel ViewModel = new DoctorSearchViewModel() { SearchPageTitle = "Pharmacy Search" };
        public PharmacySearchPage()
		{
			InitializeComponent();
            BindingContext = ViewModel;
            ViewModel.LoadCategories(DoctorSearchViewModel.PHARMACY_CAT_URL);
        }
        ...
        private void ByRetailer_Tapped(object sender, EventArgs e)
        {
        ...
        {
            await ViewModel.SearchPharmacies();
